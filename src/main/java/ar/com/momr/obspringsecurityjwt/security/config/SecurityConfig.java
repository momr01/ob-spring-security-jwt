package ar.com.momr.obspringsecurityjwt.security.config;
...
import ar.com.momr.obspringsecurityjwt.security.jwt.JwtAuthEntryPoint;
import ar.com.momr.obspringsecurityjwt.security.jwt.JwtRequestFilter;
import ar.com.momr.obspringsecurityjwt.security.service.UserDetailsServiceImpl;
...
//        configuration.setAllowedOriginPatterns(List.of("http://localhost:4200", "https://angular-springboot1-beta.vercel.app"));
        configuration.setAllowedOriginPatterns(List.of("http://localhost:4200", "https://ob-spring-security-jwt-frontend.vercel.app"));
